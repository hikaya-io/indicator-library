...
class Indicator(models.Model):
    ...
    sector = ArrayField(models.CharField(max_length=255, null=True, blank=True))
    subsector = ArrayField(models.CharField(max_length=255, null=True, blank=True))
    ...
    unit_description = models.CharField(max_length=255, null=True, blank=True, verbose_name="Unit Description"),
    disaggregation = models.CharField(max_length=255, blank=True)
    direction_of_change = models.CharField(max_length=255, null=True, blank=True, verbose_name="Direction of Change"),
    ...
    means_of_verification = models.CharField(max_length=255, null=True, blank=True, verbose_name="Means of Verification")
    question_format = models.CharField(max_length=255, null=True, blank=True, verbose_name="Question Format"),
    ...
    denominator = models.CharField(max_length=255, null=True, blank=True)
    numerator = models.CharField(max_length=255, null=True, blank=True)
